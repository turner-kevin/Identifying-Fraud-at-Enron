...
# remove 'total' record that contains totals for each feature    
data_dict.pop('TOTAL',0)

### Task 3: Create new feature(s)
# create a feature that captures percent of bonus to salary
def percent_bonus_to_salary(data_dict, features_list):
    ...
    for record in data_dict:
        ...
        if person['salary'] == 'NaN'or person['bonus'] == 'NaN':
            ...
            person['bonus_prct'] = \
            float(person['bonus']) / float(person['salary'])
